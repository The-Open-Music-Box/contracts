...
// tests for GetYouTubeDownloadStatus200Response
void main() {
  final instance = GetYouTubeDownloadStatus200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(GetYouTubeDownloadStatus200Response, () {
    // String status
