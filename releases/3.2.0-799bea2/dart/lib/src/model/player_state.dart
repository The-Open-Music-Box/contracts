...
/// * [activeTrackId] 
/// * [activeTrack] 
/// * [activeTrackNumber] - Track number in playlist (lightweight alternative to full active_track)
/// * [activeTrackTitle] - Track title (lightweight alternative to full active_track)
...
abstract class PlayerState implements Built<PlayerState, PlayerStateBuilder> {
  ...
  /// Track number in playlist (lightweight alternative to full active_track)
  @BuiltValueField(wireName: r'active_track_number')
  int? get activeTrackNumber;

  /// Track title (lightweight alternative to full active_track)
  @BuiltValueField(wireName: r'active_track_title')
  String? get activeTrackTitle;
...
class _$PlayerStateSerializer implements PrimitiveSerializer<PlayerState> {
  ...
  Iterable<Object?> _serializeProperties(
    ...
    if (object.activeTrackNumber != null) {
      yield r'active_track_number';
      yield serializers.serialize(
        object.activeTrackNumber,
        specifiedType: const FullType.nullable(int),
      );
    }
    if (object.activeTrackTitle != null) {
      yield r'active_track_title';
      yield serializers.serialize(
        object.activeTrackTitle,
        specifiedType: const FullType.nullable(String),
      );
    }
    ...
    for (var i = 0; i < serializedList.length; i += 2) {
      ...
      switch (key) {
        ...
        case r'active_track':
          ...
          break;
        case r'active_track_number':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(int),
          ) as int?;
          if (valueDes == null) continue;
          result.activeTrackNumber = valueDes;
          break;
        case r'active_track_title':
          final valueDes = serializers.deserialize(
            value,
            specifiedType: const FullType.nullable(String),
          ) as String?;
          if (valueDes == null) continue;
          result.activeTrackTitle = valueDes;
          break;
        case r'track_index':
          final valueDes = serializers.deserialize(
            value,
