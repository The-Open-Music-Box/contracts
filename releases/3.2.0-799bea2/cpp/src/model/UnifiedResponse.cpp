...
void UnifiedResponse::validate()
{
    // TODO: implement validation
}

web::json::value UnifiedResponse::toJson() const
{
...
bool UnifiedResponse::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<UnifiedResponse_data> refVal_setData;
...
void UnifiedResponse::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UnifiedResponse::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
UnifiedResponse::StatusEnum UnifiedResponse::toStatusEnum(const utility::string_t& value) const
{
...
const utility::string_t UnifiedResponse::fromStatusEnum(const StatusEnum value) const
{
    switch(value)
    {
...
UnifiedResponse::Error_typeEnum UnifiedResponse::toError_typeEnum(const utility::string_t& value) const
{
...
const utility::string_t UnifiedResponse::fromError_typeEnum(const Error_typeEnum value) const
{
    switch(value)
    {
...
UnifiedResponse::StatusEnum UnifiedResponse::getStatus() const
{
    return m_Status;
}


void UnifiedResponse::setStatus(const StatusEnum value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool UnifiedResponse::statusIsSet() const
{
    return m_StatusIsSet;
}

void UnifiedResponse::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t UnifiedResponse::getMessage() const
{
    return m_Message;
}


void UnifiedResponse::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool UnifiedResponse::messageIsSet() const
{
    return m_MessageIsSet;
}

void UnifiedResponse::unsetMessage()
{
    m_MessageIsSet = false;
}
std::shared_ptr<UnifiedResponse_data> UnifiedResponse::getData() const
{
    return m_Data;
}


void UnifiedResponse::setData(const std::shared_ptr<UnifiedResponse_data>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool UnifiedResponse::dataIsSet() const
{
    return m_DataIsSet;
}

void UnifiedResponse::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t UnifiedResponse::getClientOpId() const
{
    return m_Client_op_id;
}


void UnifiedResponse::setClientOpId(const utility::string_t& value)
{
    m_Client_op_id = value;
    m_Client_op_idIsSet = true;
}

bool UnifiedResponse::clientOpIdIsSet() const
{
    return m_Client_op_idIsSet;
}

void UnifiedResponse::unsetClient_op_id()
{
    m_Client_op_idIsSet = false;
}
double UnifiedResponse::getServerSeq() const
{
    return m_Server_seq;
}

void UnifiedResponse::setServerSeq(double value)
{
    m_Server_seq = value;
    m_Server_seqIsSet = true;
}

bool UnifiedResponse::serverSeqIsSet() const
{
    return m_Server_seqIsSet;
}

void UnifiedResponse::unsetServer_seq()
{
    m_Server_seqIsSet = false;
}
double UnifiedResponse::getTimestamp() const
{
    return m_Timestamp;
}

void UnifiedResponse::setTimestamp(double value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool UnifiedResponse::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void UnifiedResponse::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
utility::string_t UnifiedResponse::getRequestId() const
{
    return m_Request_id;
}


void UnifiedResponse::setRequestId(const utility::string_t& value)
{
    m_Request_id = value;
    m_Request_idIsSet = true;
}

bool UnifiedResponse::requestIdIsSet() const
{
    return m_Request_idIsSet;
}

void UnifiedResponse::unsetRequest_id()
{
    m_Request_idIsSet = false;
}
UnifiedResponse::Error_typeEnum UnifiedResponse::getErrorType() const
{
    return m_Error_type;
}


void UnifiedResponse::setErrorType(const Error_typeEnum value)
{
    m_Error_type = value;
    m_Error_typeIsSet = true;
}

bool UnifiedResponse::errorTypeIsSet() const
{
    return m_Error_typeIsSet;
}

void UnifiedResponse::unsetError_type()
{
    m_Error_typeIsSet = false;
}
std::map<utility::string_t, std::shared_ptr<AnyType>> UnifiedResponse::getDetails() const
{
    return m_Details;
}


void UnifiedResponse::setDetails(const std::map<utility::string_t, std::shared_ptr<AnyType>>& value)
{
    m_Details = value;
    m_DetailsIsSet = true;
}

bool UnifiedResponse::detailsIsSet() const
{
    return m_DetailsIsSet;
}

void UnifiedResponse::unsetDetails()
{
    m_DetailsIsSet = false;
}
