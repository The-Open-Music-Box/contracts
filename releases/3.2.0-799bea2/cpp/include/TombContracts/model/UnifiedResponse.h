...
#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UnifiedResponse_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UnifiedResponse_H_
...
/// Standardized response wrapper used by all API endpoints
/// </summary>
class TOMB_API UnifiedResponse
    : public ModelBase
{
public:
    UnifiedResponse();
    ...
    std::shared_ptr<UnifiedResponse_data> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::shared_ptr<UnifiedResponse_data>& value);
...
protected:
    ...
    std::shared_ptr<UnifiedResponse_data> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UnifiedResponse_H_ */
