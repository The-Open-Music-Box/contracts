...
/*
 * PlayerPlay_200_response.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PlayerPlay_200_response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PlayerPlay_200_response_H_
...
class TOMB_API PlayerPlay_200_response
    : public ModelBase
{
public:
    PlayerPlay_200_response();
    virtual ~PlayerPlay_200_response();
    ...
    /////////////////////////////////////////////
    /// PlayerPlay_200_response members
    ...
    std::shared_ptr<PlayerState> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::shared_ptr<PlayerState>& value);
...
protected:
    ...
    std::shared_ptr<PlayerState> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PlayerPlay_200_response_H_ */
