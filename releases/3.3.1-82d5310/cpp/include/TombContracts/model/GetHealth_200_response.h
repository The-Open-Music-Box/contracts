...
/*
 * GetHealth_200_response.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetHealth_200_response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetHealth_200_response_H_
...
class TOMB_API GetHealth_200_response
    : public ModelBase
{
public:
    GetHealth_200_response();
    virtual ~GetHealth_200_response();
    ...
    /////////////////////////////////////////////
    /// GetHealth_200_response members
    ...
    std::shared_ptr<HealthStatus> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::shared_ptr<HealthStatus>& value);
...
protected:
    ...
    std::shared_ptr<HealthStatus> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetHealth_200_response_H_ */
