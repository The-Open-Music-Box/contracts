...
/*
 * CreatePlaylist_201_response.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_CreatePlaylist_201_response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_CreatePlaylist_201_response_H_
...
class TOMB_API CreatePlaylist_201_response
    : public ModelBase
{
public:
    CreatePlaylist_201_response();
    virtual ~CreatePlaylist_201_response();
    ...
    /////////////////////////////////////////////
    /// CreatePlaylist_201_response members
    ...
    std::shared_ptr<PlaylistDetailed> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::shared_ptr<PlaylistDetailed>& value);
...
protected:
    ...
    std::shared_ptr<PlaylistDetailed> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_CreatePlaylist_201_response_H_ */
