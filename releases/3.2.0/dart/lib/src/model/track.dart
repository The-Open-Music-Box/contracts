...
///
/// Properties:
/// * [id] - Unique track identifier in format: {playlist_id}_{track_number}
/// * [number] - Track number in playlist
/// * [title] 
/// * [filename] 
/// * [filePath] 
/// * [duration] - DEPRECATED: Use duration_ms instead for millisecond precision. Duration in seconds. Will be removed in v4.0.0. 
/// * [durationMs] - Duration in milliseconds (preferred over duration)
/// * [artist] 
/// * [album] 
/// * [fileSize] 
/// * [createdAt] 
...
abstract class Track implements Built<Track, TrackBuilder> {
  ...
  @Deprecated('duration has been deprecated')
