...
// tests for DownloadYouTube200Response
void main() {
  final instance = DownloadYouTube200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(DownloadYouTube200Response, () {
    // String status
    ...
    // DownloadYouTube200ResponseAllOfData data
