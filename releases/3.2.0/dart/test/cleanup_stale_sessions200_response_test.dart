...
// tests for CleanupStaleSessions200Response
void main() {
  final instance = CleanupStaleSessions200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(CleanupStaleSessions200Response, () {
    // String status
    ...
    // CleanupStaleSessions200ResponseAllOfData data
    ...
    // String clientOpId
    test('to test the property `clientOpId`', () async {
      // TODO
    });
