...
/*
 * UpdatePlaylist_200_response.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UpdatePlaylist_200_response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UpdatePlaylist_200_response_H_
...
class PlayerPlay_request;


class TOMB_API UpdatePlaylist_200_response
    : public ModelBase
{
public:
    UpdatePlaylist_200_response();
    virtual ~UpdatePlaylist_200_response();
    ...
    /////////////////////////////////////////////
    /// UpdatePlaylist_200_response members
    ...
    std::shared_ptr<PlayerPlay_request> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::shared_ptr<PlayerPlay_request>& value);
...
protected:
    ...
    std::shared_ptr<PlayerPlay_request> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UpdatePlaylist_200_response_H_ */
