...
ScanNFC_200_response::ScanNFC_200_response()
{
    m_StatusIsSet = false;
...
void ScanNFC_200_response::validate()
{
    // TODO: implement validation
}

web::json::value ScanNFC_200_response::toJson() const
{
...
bool ScanNFC_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<ScanNFC_200_response_allOf_data> refVal_setData;
...
void ScanNFC_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool ScanNFC_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
ScanNFC_200_response::StatusEnum ScanNFC_200_response::toStatusEnum(const utility::string_t& value) const
{
...
const utility::string_t ScanNFC_200_response::fromStatusEnum(const StatusEnum value) const
{
    switch(value)
    {
...
ScanNFC_200_response::Error_typeEnum ScanNFC_200_response::toError_typeEnum(const utility::string_t& value) const
{
...
const utility::string_t ScanNFC_200_response::fromError_typeEnum(const Error_typeEnum value) const
{
    switch(value)
    {
...
ScanNFC_200_response::StatusEnum ScanNFC_200_response::getStatus() const
{
    return m_Status;
}


void ScanNFC_200_response::setStatus(const StatusEnum value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool ScanNFC_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void ScanNFC_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t ScanNFC_200_response::getMessage() const
{
    return m_Message;
}


void ScanNFC_200_response::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool ScanNFC_200_response::messageIsSet() const
{
    return m_MessageIsSet;
}

void ScanNFC_200_response::unsetMessage()
{
    m_MessageIsSet = false;
}
std::shared_ptr<ScanNFC_200_response_allOf_data> ScanNFC_200_response::getData() const
{
    return m_Data;
}


void ScanNFC_200_response::setData(const std::shared_ptr<ScanNFC_200_response_allOf_data>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool ScanNFC_200_response::dataIsSet() const
{
    return m_DataIsSet;
}

void ScanNFC_200_response::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t ScanNFC_200_response::getClientOpId() const
{
    return m_Client_op_id;
}


void ScanNFC_200_response::setClientOpId(const utility::string_t& value)
{
    m_Client_op_id = value;
    m_Client_op_idIsSet = true;
}

bool ScanNFC_200_response::clientOpIdIsSet() const
{
    return m_Client_op_idIsSet;
}

void ScanNFC_200_response::unsetClient_op_id()
{
    m_Client_op_idIsSet = false;
}
double ScanNFC_200_response::getServerSeq() const
{
    return m_Server_seq;
}

void ScanNFC_200_response::setServerSeq(double value)
{
    m_Server_seq = value;
    m_Server_seqIsSet = true;
}

bool ScanNFC_200_response::serverSeqIsSet() const
{
    return m_Server_seqIsSet;
}

void ScanNFC_200_response::unsetServer_seq()
{
    m_Server_seqIsSet = false;
}
double ScanNFC_200_response::getTimestamp() const
{
    return m_Timestamp;
}

void ScanNFC_200_response::setTimestamp(double value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool ScanNFC_200_response::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void ScanNFC_200_response::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
utility::string_t ScanNFC_200_response::getRequestId() const
{
    return m_Request_id;
}


void ScanNFC_200_response::setRequestId(const utility::string_t& value)
{
    m_Request_id = value;
    m_Request_idIsSet = true;
}

bool ScanNFC_200_response::requestIdIsSet() const
{
    return m_Request_idIsSet;
}

void ScanNFC_200_response::unsetRequest_id()
{
    m_Request_idIsSet = false;
}
ScanNFC_200_response::Error_typeEnum ScanNFC_200_response::getErrorType() const
{
    return m_Error_type;
}


void ScanNFC_200_response::setErrorType(const Error_typeEnum value)
{
    m_Error_type = value;
    m_Error_typeIsSet = true;
}

bool ScanNFC_200_response::errorTypeIsSet() const
{
    return m_Error_typeIsSet;
}

void ScanNFC_200_response::unsetError_type()
{
    m_Error_typeIsSet = false;
}
std::map<utility::string_t, std::shared_ptr<AnyType>> ScanNFC_200_response::getDetails() const
{
    return m_Details;
}


void ScanNFC_200_response::setDetails(const std::map<utility::string_t, std::shared_ptr<AnyType>>& value)
{
    m_Details = value;
    m_DetailsIsSet = true;
}

bool ScanNFC_200_response::detailsIsSet() const
{
    return m_DetailsIsSet;
}

void ScanNFC_200_response::unsetDetails()
{
    m_DetailsIsSet = false;
}
