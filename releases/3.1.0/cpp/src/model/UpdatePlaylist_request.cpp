...
UpdatePlaylist_request::UpdatePlaylist_request()
{
...
void UpdatePlaylist_request::validate()
{
    // TODO: implement validation
}

web::json::value UpdatePlaylist_request::toJson() const
{
...
bool UpdatePlaylist_request::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdatePlaylist_request::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdatePlaylist_request::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t UpdatePlaylist_request::getTitle() const
{
    return m_Title;
}


void UpdatePlaylist_request::setTitle(const utility::string_t& value)
{
    m_Title = value;
    m_TitleIsSet = true;
}

bool UpdatePlaylist_request::titleIsSet() const
{
    return m_TitleIsSet;
}

void UpdatePlaylist_request::unsetTitle()
{
    m_TitleIsSet = false;
}
utility::string_t UpdatePlaylist_request::getDescription() const
{
    return m_Description;
}


void UpdatePlaylist_request::setDescription(const utility::string_t& value)
{
    m_Description = value;
    m_DescriptionIsSet = true;
}

bool UpdatePlaylist_request::descriptionIsSet() const
{
    return m_DescriptionIsSet;
}

void UpdatePlaylist_request::unsetDescription()
{
    m_DescriptionIsSet = false;
}
utility::string_t UpdatePlaylist_request::getClientOpId() const
{
    return m_Client_op_id;
}


void UpdatePlaylist_request::setClientOpId(const utility::string_t& value)
{
    m_Client_op_id = value;
    m_Client_op_idIsSet = true;
}

bool UpdatePlaylist_request::clientOpIdIsSet() const
{
    return m_Client_op_idIsSet;
}

void UpdatePlaylist_request::unsetClient_op_id()
{
    m_Client_op_idIsSet = false;
}
