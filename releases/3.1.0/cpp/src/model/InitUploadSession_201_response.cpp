...
InitUploadSession_201_response::InitUploadSession_201_response()
{
    m_StatusIsSet = false;
...
void InitUploadSession_201_response::validate()
{
    // TODO: implement validation
}

web::json::value InitUploadSession_201_response::toJson() const
{
...
bool InitUploadSession_201_response::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<UploadSession> refVal_setData;
...
void InitUploadSession_201_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InitUploadSession_201_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
InitUploadSession_201_response::StatusEnum InitUploadSession_201_response::toStatusEnum(const utility::string_t& value) const
{
...
const utility::string_t InitUploadSession_201_response::fromStatusEnum(const StatusEnum value) const
{
    switch(value)
    {
...
InitUploadSession_201_response::Error_typeEnum InitUploadSession_201_response::toError_typeEnum(const utility::string_t& value) const
{
...
const utility::string_t InitUploadSession_201_response::fromError_typeEnum(const Error_typeEnum value) const
{
    switch(value)
    {
...
InitUploadSession_201_response::StatusEnum InitUploadSession_201_response::getStatus() const
{
    return m_Status;
}


void InitUploadSession_201_response::setStatus(const StatusEnum value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool InitUploadSession_201_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void InitUploadSession_201_response::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t InitUploadSession_201_response::getMessage() const
{
    return m_Message;
}


void InitUploadSession_201_response::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool InitUploadSession_201_response::messageIsSet() const
{
    return m_MessageIsSet;
}

void InitUploadSession_201_response::unsetMessage()
{
    m_MessageIsSet = false;
}
std::shared_ptr<UploadSession> InitUploadSession_201_response::getData() const
{
    return m_Data;
}


void InitUploadSession_201_response::setData(const std::shared_ptr<UploadSession>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool InitUploadSession_201_response::dataIsSet() const
{
    return m_DataIsSet;
}

void InitUploadSession_201_response::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t InitUploadSession_201_response::getClientOpId() const
{
    return m_Client_op_id;
}


void InitUploadSession_201_response::setClientOpId(const utility::string_t& value)
{
    m_Client_op_id = value;
    m_Client_op_idIsSet = true;
}

bool InitUploadSession_201_response::clientOpIdIsSet() const
{
    return m_Client_op_idIsSet;
}

void InitUploadSession_201_response::unsetClient_op_id()
{
    m_Client_op_idIsSet = false;
}
double InitUploadSession_201_response::getServerSeq() const
{
    return m_Server_seq;
}

void InitUploadSession_201_response::setServerSeq(double value)
{
    m_Server_seq = value;
    m_Server_seqIsSet = true;
}

bool InitUploadSession_201_response::serverSeqIsSet() const
{
    return m_Server_seqIsSet;
}

void InitUploadSession_201_response::unsetServer_seq()
{
    m_Server_seqIsSet = false;
}
double InitUploadSession_201_response::getTimestamp() const
{
    return m_Timestamp;
}

void InitUploadSession_201_response::setTimestamp(double value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool InitUploadSession_201_response::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void InitUploadSession_201_response::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
utility::string_t InitUploadSession_201_response::getRequestId() const
{
    return m_Request_id;
}


void InitUploadSession_201_response::setRequestId(const utility::string_t& value)
{
    m_Request_id = value;
    m_Request_idIsSet = true;
}

bool InitUploadSession_201_response::requestIdIsSet() const
{
    return m_Request_idIsSet;
}

void InitUploadSession_201_response::unsetRequest_id()
{
    m_Request_idIsSet = false;
}
InitUploadSession_201_response::Error_typeEnum InitUploadSession_201_response::getErrorType() const
{
    return m_Error_type;
}


void InitUploadSession_201_response::setErrorType(const Error_typeEnum value)
{
    m_Error_type = value;
    m_Error_typeIsSet = true;
}

bool InitUploadSession_201_response::errorTypeIsSet() const
{
    return m_Error_typeIsSet;
}

void InitUploadSession_201_response::unsetError_type()
{
    m_Error_typeIsSet = false;
}
std::map<utility::string_t, std::shared_ptr<AnyType>> InitUploadSession_201_response::getDetails() const
{
    return m_Details;
}


void InitUploadSession_201_response::setDetails(const std::map<utility::string_t, std::shared_ptr<AnyType>>& value)
{
    m_Details = value;
    m_DetailsIsSet = true;
}

bool InitUploadSession_201_response::detailsIsSet() const
{
    return m_DetailsIsSet;
}

void InitUploadSession_201_response::unsetDetails()
{
    m_DetailsIsSet = false;
}
