...
// tests for ListUploadSessions200Response
void main() {
  final instance = ListUploadSessions200ResponseBuilder();
  // TODO add properties to the builder and call build()

  group(ListUploadSessions200Response, () {
    // String status
    ...
    // ListUploadSessions200ResponseAllOfData data
