...
/*
 * UploadChunk_200_response.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_UploadChunk_200_response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_UploadChunk_200_response_H_
...
class TOMB_API UploadChunk_200_response
    : public ModelBase
{
public:
    UploadChunk_200_response();
    virtual ~UploadChunk_200_response();
    ...
    /////////////////////////////////////////////
    /// UploadChunk_200_response members
    ...
    std::shared_ptr<ChunkUploadResult> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::shared_ptr<ChunkUploadResult>& value);
...
protected:
    ...
    std::shared_ptr<ChunkUploadResult> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_UploadChunk_200_response_H_ */
