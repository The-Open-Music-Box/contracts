...
public:
    ...
    /// </summary>
    int32_t getActiveTrackNumber() const;
    bool activeTrackNumberIsSet() const;
    void unsetActive_track_number();
    void setActiveTrackNumber(int32_t value);

    /// <summary>
    /// Track title (lightweight alternative to full active_track)
    /// </summary>
    utility::string_t getActiveTrackTitle() const;
    bool activeTrackTitleIsSet() const;
    void unsetActive_track_title();
    void setActiveTrackTitle(const utility::string_t& value);
...
protected:
    ...
    int32_t m_Active_track_number;
    bool m_Active_track_numberIsSet;

    utility::string_t m_Active_track_title;
    bool m_Active_track_titleIsSet;
