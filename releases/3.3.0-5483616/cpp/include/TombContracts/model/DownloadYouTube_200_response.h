...
/*
 * DownloadYouTube_200_response.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_DownloadYouTube_200_response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_DownloadYouTube_200_response_H_
...
class DownloadYouTube_200_response_allOf_data;


class TOMB_API DownloadYouTube_200_response
    : public ModelBase
{
public:
    DownloadYouTube_200_response();
    virtual ~DownloadYouTube_200_response();
    ...
    /////////////////////////////////////////////
    /// DownloadYouTube_200_response members
    ...
    std::shared_ptr<DownloadYouTube_200_response_allOf_data> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::shared_ptr<DownloadYouTube_200_response_allOf_data>& value);
...
protected:
    ...
    std::shared_ptr<DownloadYouTube_200_response_allOf_data> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_DownloadYouTube_200_response_H_ */
