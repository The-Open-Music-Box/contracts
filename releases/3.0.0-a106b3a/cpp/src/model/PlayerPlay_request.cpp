...
PlayerPlay_request::PlayerPlay_request()
{
...
void PlayerPlay_request::validate()
{
    // TODO: implement validation
}

web::json::value PlayerPlay_request::toJson() const
{
...
bool PlayerPlay_request::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PlayerPlay_request::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PlayerPlay_request::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t PlayerPlay_request::getClientOpId() const
{
    return m_Client_op_id;
}


void PlayerPlay_request::setClientOpId(const utility::string_t& value)
{
    m_Client_op_id = value;
    m_Client_op_idIsSet = true;
}

bool PlayerPlay_request::clientOpIdIsSet() const
{
    return m_Client_op_idIsSet;
}

void PlayerPlay_request::unsetClient_op_id()
{
    m_Client_op_idIsSet = false;
}
