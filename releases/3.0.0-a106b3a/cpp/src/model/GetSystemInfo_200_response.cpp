...
GetSystemInfo_200_response::GetSystemInfo_200_response()
{
    m_StatusIsSet = false;
...
void GetSystemInfo_200_response::validate()
{
    // TODO: implement validation
}

web::json::value GetSystemInfo_200_response::toJson() const
{
...
bool GetSystemInfo_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
    ...
    if(val.has_field(utility::conversions::to_string_t(_XPLATSTR("data"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<GetSystemInfo_200_response_allOf_data> refVal_setData;
...
void GetSystemInfo_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool GetSystemInfo_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
GetSystemInfo_200_response::StatusEnum GetSystemInfo_200_response::toStatusEnum(const utility::string_t& value) const
{
...
const utility::string_t GetSystemInfo_200_response::fromStatusEnum(const StatusEnum value) const
{
    switch(value)
    {
...
GetSystemInfo_200_response::Error_typeEnum GetSystemInfo_200_response::toError_typeEnum(const utility::string_t& value) const
{
...
const utility::string_t GetSystemInfo_200_response::fromError_typeEnum(const Error_typeEnum value) const
{
    switch(value)
    {
...
GetSystemInfo_200_response::StatusEnum GetSystemInfo_200_response::getStatus() const
{
    return m_Status;
}


void GetSystemInfo_200_response::setStatus(const StatusEnum value)
{
    m_Status = value;
    m_StatusIsSet = true;
}

bool GetSystemInfo_200_response::statusIsSet() const
{
    return m_StatusIsSet;
}

void GetSystemInfo_200_response::unsetStatus()
{
    m_StatusIsSet = false;
}
utility::string_t GetSystemInfo_200_response::getMessage() const
{
    return m_Message;
}


void GetSystemInfo_200_response::setMessage(const utility::string_t& value)
{
    m_Message = value;
    m_MessageIsSet = true;
}

bool GetSystemInfo_200_response::messageIsSet() const
{
    return m_MessageIsSet;
}

void GetSystemInfo_200_response::unsetMessage()
{
    m_MessageIsSet = false;
}
std::shared_ptr<GetSystemInfo_200_response_allOf_data> GetSystemInfo_200_response::getData() const
{
    return m_Data;
}


void GetSystemInfo_200_response::setData(const std::shared_ptr<GetSystemInfo_200_response_allOf_data>& value)
{
    m_Data = value;
    m_DataIsSet = true;
}

bool GetSystemInfo_200_response::dataIsSet() const
{
    return m_DataIsSet;
}

void GetSystemInfo_200_response::unsetData()
{
    m_DataIsSet = false;
}
utility::string_t GetSystemInfo_200_response::getClientOpId() const
{
    return m_Client_op_id;
}


void GetSystemInfo_200_response::setClientOpId(const utility::string_t& value)
{
    m_Client_op_id = value;
    m_Client_op_idIsSet = true;
}

bool GetSystemInfo_200_response::clientOpIdIsSet() const
{
    return m_Client_op_idIsSet;
}

void GetSystemInfo_200_response::unsetClient_op_id()
{
    m_Client_op_idIsSet = false;
}
double GetSystemInfo_200_response::getServerSeq() const
{
    return m_Server_seq;
}

void GetSystemInfo_200_response::setServerSeq(double value)
{
    m_Server_seq = value;
    m_Server_seqIsSet = true;
}

bool GetSystemInfo_200_response::serverSeqIsSet() const
{
    return m_Server_seqIsSet;
}

void GetSystemInfo_200_response::unsetServer_seq()
{
    m_Server_seqIsSet = false;
}
double GetSystemInfo_200_response::getTimestamp() const
{
    return m_Timestamp;
}

void GetSystemInfo_200_response::setTimestamp(double value)
{
    m_Timestamp = value;
    m_TimestampIsSet = true;
}

bool GetSystemInfo_200_response::timestampIsSet() const
{
    return m_TimestampIsSet;
}

void GetSystemInfo_200_response::unsetTimestamp()
{
    m_TimestampIsSet = false;
}
utility::string_t GetSystemInfo_200_response::getRequestId() const
{
    return m_Request_id;
}


void GetSystemInfo_200_response::setRequestId(const utility::string_t& value)
{
    m_Request_id = value;
    m_Request_idIsSet = true;
}

bool GetSystemInfo_200_response::requestIdIsSet() const
{
    return m_Request_idIsSet;
}

void GetSystemInfo_200_response::unsetRequest_id()
{
    m_Request_idIsSet = false;
}
GetSystemInfo_200_response::Error_typeEnum GetSystemInfo_200_response::getErrorType() const
{
    return m_Error_type;
}


void GetSystemInfo_200_response::setErrorType(const Error_typeEnum value)
{
    m_Error_type = value;
    m_Error_typeIsSet = true;
}

bool GetSystemInfo_200_response::errorTypeIsSet() const
{
    return m_Error_typeIsSet;
}

void GetSystemInfo_200_response::unsetError_type()
{
    m_Error_typeIsSet = false;
}
std::map<utility::string_t, std::shared_ptr<AnyType>> GetSystemInfo_200_response::getDetails() const
{
    return m_Details;
}


void GetSystemInfo_200_response::setDetails(const std::map<utility::string_t, std::shared_ptr<AnyType>>& value)
{
    m_Details = value;
    m_DetailsIsSet = true;
}

bool GetSystemInfo_200_response::detailsIsSet() const
{
    return m_DetailsIsSet;
}

void GetSystemInfo_200_response::unsetDetails()
{
    m_DetailsIsSet = false;
}
