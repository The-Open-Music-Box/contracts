...
/*
 * ScanNFC_200_response.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_ScanNFC_200_response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_ScanNFC_200_response_H_
...
class ScanNFC_200_response_allOf_data;


class TOMB_API ScanNFC_200_response
    : public ModelBase
{
public:
    ScanNFC_200_response();
    virtual ~ScanNFC_200_response();
    ...
    std::shared_ptr<ScanNFC_200_response_allOf_data> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::shared_ptr<ScanNFC_200_response_allOf_data>& value);
...
protected:
    ...
    std::shared_ptr<ScanNFC_200_response_allOf_data> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_ScanNFC_200_response_H_ */
