...
/*
 * FinalizeUpload_200_response.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_FinalizeUpload_200_response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_FinalizeUpload_200_response_H_
...
class TOMB_API FinalizeUpload_200_response
    : public ModelBase
{
public:
    FinalizeUpload_200_response();
    virtual ~FinalizeUpload_200_response();
    ...
    /////////////////////////////////////////////
    /// FinalizeUpload_200_response members
    ...
    std::shared_ptr<UploadFinalizeResult> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::shared_ptr<UploadFinalizeResult>& value);
...
protected:
    ...
    std::shared_ptr<UploadFinalizeResult> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_FinalizeUpload_200_response_H_ */
