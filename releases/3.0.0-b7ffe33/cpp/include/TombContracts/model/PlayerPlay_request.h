...
/*
 * PlayerPlay_request.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PlayerPlay_request_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PlayerPlay_request_H_
...
class TOMB_API PlayerPlay_request
    : public ModelBase
{
public:
    PlayerPlay_request();
    virtual ~PlayerPlay_request();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PlayerPlay_request_H_ */
