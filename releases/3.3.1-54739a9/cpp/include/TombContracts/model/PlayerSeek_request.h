...
/*
 * PlayerSeek_request.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_PlayerSeek_request_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_PlayerSeek_request_H_
...
class TOMB_API PlayerSeek_request
    : public ModelBase
{
public:
    PlayerSeek_request();
    virtual ~PlayerSeek_request();
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_PlayerSeek_request_H_ */
