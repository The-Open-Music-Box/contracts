...
/*
 * GetYouTubeDownloadStatus_200_response.h
 *
 * 
 */

#ifndef ORG_OPENAPITOOLS_CLIENT_MODEL_GetYouTubeDownloadStatus_200_response_H_
#define ORG_OPENAPITOOLS_CLIENT_MODEL_GetYouTubeDownloadStatus_200_response_H_
...
class YouTubeDownloadStatus;


class TOMB_API GetYouTubeDownloadStatus_200_response
    : public ModelBase
{
public:
    GetYouTubeDownloadStatus_200_response();
    virtual ~GetYouTubeDownloadStatus_200_response();
    ...
    /////////////////////////////////////////////
    /// GetYouTubeDownloadStatus_200_response members
    ...
    std::shared_ptr<YouTubeDownloadStatus> getData() const;
    bool dataIsSet() const;
    void unsetData();
    void setData(const std::shared_ptr<YouTubeDownloadStatus>& value);
...
protected:
    ...
    std::shared_ptr<YouTubeDownloadStatus> m_Data;
    bool m_DataIsSet;
...
#endif /* ORG_OPENAPITOOLS_CLIENT_MODEL_GetYouTubeDownloadStatus_200_response_H_ */
