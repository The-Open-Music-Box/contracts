...
export interface components {
    schemas: {
        ...
        /**
         * @description Backend capability flags that declare what features and formats this backend supports.
        ...
        BackendCapabilities: {
             ...
             * @enum {string}
             */
            upload_format: "raw_binary" | "multipart";
            /**
            ...
            /**
             * @description If LED control (strip/hat) is available
             * @default false
             * @example true
             */
            led_control: boolean;
             ...
             * @example 1000
             */
            position_update_interval_ms: number;
            /**
             ...
             * @example true
             */
            supports_websocket_position: boolean;
        };
        HealthStatus: {
            /** @enum {string} */
...
export interface operations {
    ...
    updatePlaylist: {
        ...
        responses: {
            /** @description Updated playlist with full details */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                ...
                content: {
                    "application/json": components["schemas"]["UnifiedResponse"] & {
                        data?: {
                             ...
                             */
                            uptime: number;
                            /** @description Platform-specific capabilities and supported formats */
